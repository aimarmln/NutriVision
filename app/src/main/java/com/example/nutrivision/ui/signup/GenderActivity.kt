...
class GenderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnContinueGender.setOnClickListener {
            ...
            val selectedGender = gender.replace(Regex("[^A-Za-z ]"), "").trim()

            signupUser?.gender = selectedGender

            Log.d("GenderActivity", "SignupUser value:$signupUser")

            val intent = Intent(this@GenderActivity, BirthdayActivity::class.java)
